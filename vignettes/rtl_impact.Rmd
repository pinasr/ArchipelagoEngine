...
> * **The Methodology:** Using a localized 'palay' prices of the Philippines from 2016-2025, we demonstrate the limitations of traditional Queen-contiguity in maritime environments to accurately capture maritime spillovers, noting a statistically significant error bias ($p < 0.05$).
